...
<footer class="px-4 divide-y bg-zinc-900 text-gray-100">
    <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div class="lg:w-1/3">
            <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
                <div class="flex items-center justify-center w-16 h-16 rounded-full">
                    <img class="" src="static/images/mnnit_logo.jpg" alt="MNNIT" />
                </div>
                <span class="self-center text-2xl font-semibold">SAC MNNIT</span>
            </a>
        </div>
        <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div class="space-y-3">
                <h3 class="tracking-wide uppercase text-gray-50">Quick Links</h3>
                <ul class="space-y-1">
                    <li>
            ...
            <div class="space-y-3">
                <h3 class="tracking-wide uppercase text-gray-50">Events</h3>
                <ul class="space-y-1">
                    <li>
            ...
            <div class="space-y-3">
                <h3 class="uppercase text-gray-50">Contact Us</h3>
                <ul class="space-y-1">
                    <li>
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-start space-x-3">
                    <a rel="noopener noreferrer" href="https://www.facebook.com/MNNITALLD/" title="Facebook" class="flex items-center p-1">
                    ...
                    <a rel="noopener noreferrer" href="https://twitter.com/MNNITALLD" title="Twitter" class="flex items-center p-1">
                    ...
                    <a rel="noopener noreferrer" href="https://www.instagram.com/mnnitalld" title="Instagram" class="flex items-center p-1">
    ...
    <div class="py-6 text-sm text-center text-gray-400">© 2023 CC MNNIT. All rights reserved.</div>
</footer>
