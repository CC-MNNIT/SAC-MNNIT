          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
              ...
              <ul className="space-y-1">
                ...
                <li>
                  <a
                    rel="noopener noreferrer"
                    target="_blank"
                    href="http://www.mnnit.ac.in/index.php/anti-ragging"
                  >
                    Anti-Ragging
                  </a>
                </li>
              ...
              <ul className="space-y-1">
                <li>
                  <a
                    rel="noopener noreferrer"
                    target="_blank"
                    href="https://avishkar.mnnit.ac.in"
                  >
                    Avishkar
                  </a>
                </li>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                <li>
                  <a rel="noopener noreferrer" href="/">
                    S.A.C. Office and Boys’ SAC
                  </a>
                </li>
                <li>
                  <a rel="noopener noreferrer" href="/">
                    Gymkhana and Girls’ SAC
                  </a>
                </li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <div className="flex justify-start space-x-3">
                <a
                  rel="noopener noreferrer"
                  target="_blank"
                  href="https://www.facebook.com/MNNITALLD/"
                  title="Facebook"
                ...
                <a
                  rel="noopener noreferrer"
                  target="_blank"
                  href="https://twitter.com/MNNITALLD"
                  title="Twitter"
                  className="flex items-center p-1"
                >
                  <svg
                ...
                <a
                  rel="noopener noreferrer"
                  target="_blank"
                  href="https://www.instagram.com/mnnitalld"
                  title="Instagram"
                  className="flex items-center p-1"
                >
                  <svg
