...
<body>
    ...
    <div class="container mx-auto mt-20">
        <div class="d-flex text-center justify-content-center pt-0 text-3xl font-weight-900">
            <h2>
                <span class="font-bold text-2xl md:text-2xl tracking-tight">TEAM</span>
            </h2>
        </div>
        <hr class="w-20 h-1 mx-auto my-2 bg-red-700 border-0 rounded" />

        <div class="box flex-col md:flex-row m-8">
            <div class="p-8 bg-white rounded-lg shadow items-center md:flex-row justify evenly">
                <div class="flex flex-col items-center md:flex-row justify evenly">
                    <div class="p-4">
                        <div class="mb-4 text-center opacity-90">
                            <a href="#" class="relative block">
                                <img alt="profile" src="https://github.com/shank03.png" class="mx-auto object-cover rounded-full h-40 w-40 " />
                            </a>
                        </div>
                    ...
                    <div class="p-4">
                        <div class="mb-4 text-center opacity-90">
                            <a href="#" class="relative block">
                                <img alt="profile" src="https://github.com/prackode.png" class="mx-auto object-cover rounded-full h-40 w-40 " />
                            </a>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl text-gray-800">
                    ...
                    <div class="p-4">
                        <div class="mb-4 text-center opacity-90">
                            <a href="#" class="relative block">
                                <img alt="profile" src="https://github.com/ashutoshsuthar2020.png" class="mx-auto object-cover rounded-full h-40 w-40 " />
                            </a>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl text-gray-800">
                    ...
                    <div class="p-4">
                        <div class="mb-4 text-center opacity-90">
                            <a href="#" class="relative block">
                                <img alt="profile" src="https://github.com/mitrukahitesh.png" class="mx-auto object-cover rounded-full h-40 w-40 " />
                            </a>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl text-gray-800">
                    ...
                    <div class="p-4">
                        <div class="mb-4 text-center opacity-90">
                            <a href="#" class="relative block">
                                <img alt="profile" src="https://github.com/hackeramitkumar.png" class="mx-auto object-cover rounded-full h-40 w-40 " />
                            </a>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl text-gray-800">
