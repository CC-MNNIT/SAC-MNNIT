...
<body>
    ...
    <div class="font-sans m-1 mt-8 transition-all">
        <div class="maincontent1 rounded overflow-hidden p-8 mx-8 mt-8 bg-gray-100 shadow-lg hover:shadow-2xl duration-300">
        ...
        <div class="maincontent2 rounded overflow-hidden p-8 m-8 bg-gray-100 shadow-lg hover:shadow-2xl duration-300">
            <div class="text-center">
                <div class="row">
                    <div class="col">
        ...
        <div class="flex m-8">
            <div class="flex flex-col rounded-lg bg-white shadow-lg dark:bg-neutral-700 md:max-w md:flex-row">
